    ...
    return (
        <Box sx={{ width: 320, height: 843, p:3 }}>
            <Card variant="outlined">
                <CardContent>
                <Box component="img" sx={{ display: 'block', height:220, mx: 'auto'}} src={Volunteering} alt="Фото Запроса"  />
                
                <Box sx={{ height:128, display: 'flex' }}>
                    <Typography sx={{ width: 256, height: 96, marginTop: 1, mt: 2, mb: 2 }} variant="h5">
                        Сбор средств для пенсионерки Ангелины Ивановны 
                    </Typography>
                    <Box sx={{ width: 32, height: 32, border: 1, borderRadius: 0.5, display: 'flex', alignItems: 'center', justifyContent: 'center', mt:2, color: 'rgba(0, 0, 0, 0.12)' }}>
                        <Box component="img" sx={{ display: 'block', height:24, width: 24}} src={Star} alt="Фото Запроса"  />
                    </Box>
                </Box> 
                ...
                <Button variant="contained" color="primary" sx={{ mt: 2, width:288}}>
                    Помочь
                </Button>
                </CardContent>
            </Card>
